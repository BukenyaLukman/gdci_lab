    ...
    <div class="container px-6 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div>
                ...
                <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Ovarian Cancer using Vision Transformers</h1>

                <p class="mt-2 text-gray-500 dark:text-gray-400">We are working on a project to detect Ovarian Cancer using Vision Transformers. The UBC Ovarian cancer is a kaggle challenge were UBC Ovarian Cancer subtypE clAssification and outlier detectioN (UBC-OCEAN) competition is to classify ovarian cancer subtypes. You will build a model trained on the world's most extensive ovarian cancer dataset of histopathology images obtained from more than 20 medical centers.</p>
            </div>
            ...
            <div>
                ...
                <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Maternal Online Technology for Healthcare</h1>

                <p class="mt-2 text-gray-500 dark:text-gray-400">We are developing a Maternal Online Technology for Healthcare Information Dissemination.</p>
            </div>
            ...
            <div>
                ...
                <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Food Nutrient Estimation Algorithm.</h1>

                <p class="mt-2 text-gray-500 dark:text-gray-400">In our commitment to enhancing nutritional awareness, we're developing a sophisticated Food Nutrient Estimation Algorithm for individual use. This innovative tool employs advanced calculations to swiftly analyze dietary intake, offering users precise insights into essential nutrients. Tailored for human use, our algorithm supports informed and healthier eating decisions, contributing to overall well-being and fostering a deeper understanding of personal nutritional needs.</p>
            </div>
        </div>
    </div>
</section>
